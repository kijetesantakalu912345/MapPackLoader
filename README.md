...
This mod was originally made for the bopl battle 2 tournament server, but anybody is free to use it for their own mod packs. just include an extra `mappack.zip` in your modpack
package.zip file and Map Pack Loader should load it.
...
- You can put `mappack.zip` in a sub folder of the plugins folder as well. Map Pack Loader will still find it.
